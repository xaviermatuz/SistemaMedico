...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        tpl: {
            ...
            message:         '<div  class="dropify-message" align="center"><span class="file-icon" /> <p align="center">{{ default }}</p></div>',
